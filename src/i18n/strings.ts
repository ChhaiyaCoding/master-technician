...
export const t = {
  ...
  result: {
    ...
    low: "ទាប",
    disclaimer:
      "លទ្ធផលនេះជាការណែនាំបឋម (placeholder AI)។ សូមផ្ទៀងផ្ទាត់ជាមួយការវាស់ជាក់ស្តែង។",
  },
  ...
  settings: {
    ...
    about: "អំពី",
    aboutText:
      "Master Technician — កម្មវិធីជំនួយវិនិច្ឆ័យសម្រាប់ជាងម៉ាស៊ីនរថយន្តអាជីព។ ទិន្នន័យ AI ជា placeholder សម្រាប់ពេលនេះ។",
    dataMgmt: "ទិន្នន័យ",
